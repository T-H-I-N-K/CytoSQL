...
public class CustomTableModel extends DefaultTableModel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7752590663470256769L;
	...
	public void addColumn(Object columnName, Vector columnData, Class colType) {
		this.addColumn(columnName, columnData, colType, columnName.toString()
				.length() * 10);
	}
	...
	public Class getColumnClass(int col) {
		return colTypes[col].equals(java.sql.Blob.class) ? String.class
				: colTypes[col];
	}
